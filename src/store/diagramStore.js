      ...
      addEdge: (connection) => {
        ...
        const edge = {
          ...
          data: {
            ...
            wireFittingFrom: srcPort.installedConnector ?? srcPort.fitting ?? defaultFittingForType(type),
            wireFittingTo: tgtPort?.installedConnector ?? tgtPort?.fitting ?? defaultFittingForType(type),
            label,
            labelEdited: false,
            length: null,
            notes: '',
